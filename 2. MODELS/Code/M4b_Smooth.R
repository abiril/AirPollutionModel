...
save(out, file = "MODELS/MODEL/Outputs/M4b_Smooth.RData")

load(file = "MODELS/MODEL/Outputs/M4b_Smooth.RData")
summary(out)
...
save(results, file = "MODELS/MODEL/Outputs/M4b_Smooth_TimeCV.RData")

load(file = "MODELS/MODEL/Outputs/M4b_Smooth_TimeCV.RData")
...
results <- do.call(rbind, results_list)
save(results, file = "MODELS/MODEL/Outputs/M4b_Smooth_SpatialBlockCV.RData")
