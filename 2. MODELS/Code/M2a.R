...
save(out, file = "MODELS/FINAL/Outputs/M2a.RData")

load(file = "MODELS/FINAL/Outputs/M2a.RData")
summary(out)
...
save(results, file = "MODELS/FINAL/Outputs/M2a_TimeCV.RData")

load(file = "MODELS/FINAL/Outputs/M2a_TimeCV.RData")
...
results <- do.call(rbind, results_list)
save(results, file = "MODELS/FINAL/Outputs/M2a_SpatialBlockCV.RData")
