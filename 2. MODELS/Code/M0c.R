...
inla.setOption(smtp = "taucs",  inla.mode = "classic", num.threads = "6:4")
...
save(out, file = "MODELS/MODEL/Outputs/M0c.RData")

load(file = "MODELS/MODEL/Outputs/M0c.RData")
summary(out)
...
save(results, file = "MODELS/MODEL/Outputs/M0c_exp_TimeCV.RData")

load(file = "MODELS/MODEL/Outputs/M0c_exp_TimeCV.RData")
...
results <- do.call(rbind, results_list)
save(results, file = "MODELS/MODEL/Outputs/M0c_exp_SpatialBlockCV.RData")
