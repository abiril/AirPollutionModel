...
save(out, file = "MODELS/MODEL/Outputs/M4b.RData")

load(file = "MODELS/MODEL/Outputs/M4b.RData")
summary(out)
...
save(results, file = "MODELS/MODEL/Outputs/M4b_TimeCV.RData")

load(file = "MODELS/MODEL/Outputs/M4b_TimeCV.RData")
...
results <- do.call(rbind, results_list)
save(results, file = "MODELS/MODEL/Outputs/M4b_SpatialBlockCV.RData")
