...
save(out, file = "MODELS/MODEL/Outputs/M0a.RData")

load(file = "MODELS/MODEL/Outputs/M0a.RData")
...
save(results, file = "MODELS/MODEL/Outputs/M0a_TimeCV.RData")

load(file = "MODELS/MODEL/Outputs/M0a_TimeCV.RData")
...
results <- do.call(rbind, results_list)
save(results, file = "MODELS/MODEL/Outputs/M0a_SpatialBlockCV.RData")
